...
library(knitr)
kable(data[1:8, ], caption = "Overview of ESG Strategies.")
```
:::
...
library(knitr)
kable(data[1:7, ], caption = "Overview of Impact Investment Strategies.")
```
:::
...
library(knitr)
kable(data[1:5, ], caption = "Overview of Green Finance and Social Finance.")
```
:::
...
library(knitr)
kable(data[1:5, ], caption = "Overview of Governance and Ethical Investing.")
```
:::
