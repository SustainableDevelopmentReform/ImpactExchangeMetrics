...
authors:
  - name: Arlette Schramm
    affiliations:
      - Centre for Sustainable Development Reform, University of New South Wales (UNSW-CSDR)
  - name: Marianne Feoli
    affiliations:
      - UNSW-CSDR
  - name: Ben Milligan
...
![Conceptual basis for organising environmental, social and economic metrics aligned to international statistical standards. Source: @united_nations_statistics_division_2024.](media/Picture%201.png)
...
![Methodology for market studies on sustainability-related investments. Source: @eurosif_classification_report_2024.](media/Picture%202.png)
...
![Interconnectedness of IRIS+ Impact Categories and Themes as of May 2021. Source: [iris.thegiin.org](https://iris.thegiin.org).](media/Picture%203.jpg)
...
![Illustrative tiers of analytical approaches to impact and ESG assessment](media/Picture%204.png)
...
![Role of guiding principles and frameworks for ESG investment assessment](media/Picture%205.png)
...
![Role of guiding principles and frameworks for ESG investment assessment](media/Picture%206.png)
